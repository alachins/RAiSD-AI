...
RAiSD versions 2.7-3.1 required the [GNU Scientific Library (GSL)](https://www.gnu.org/software/gsl/) to calculate μ values based on interpolation in grid-based scans. This is no longer required, as RAiSD-AI contains a native implementation of grid-based scans for both the μ statistic and the CNN.  
...
The quick-reference help message generated by the current RAiSD release is the following.
      ...
      This is RAiSD version 3.0, released in July 2021.
