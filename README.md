...
RAiSD-AI: a software tool for training, testing, and deploying Convolutional Neural Networks for selective sweep detection
===============================================
...
The main article describing RAiSD and the μ statisticc is published in Communications Biology:
...
4. Create the Conda environment for RAiSD-AI. Choose one of the following configurations:
...
6. Activate the Conda environment for RAiSD-AI and compile:
   ...
   ```
	...
	The executable is placed in the path RAiSD-AI-master/bin/release. A link to the executable is placed in the installation folder, i.e., RAiSD-AI-master. 
...
#### Operations 2 and 3: Train and test SweepNet (TensorFlow = 100 seconds, PyTorch = 80 seconds)
...
#### Operation 4: Train and test FASTER-NN (70 seconds)

The following command will train (10 epochs) and test the FASTER-NN network architecture, generating models for all previously generated data types and formats that are supported with FASTER-NN. FASTER-NN is only implemented in PyTorch.
